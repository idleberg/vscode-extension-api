...
export async function activate(context: ExtensionContext): Promise<void> {
	...
	context.subscriptions.push(
		commands.registerCommand(
			"extension.extension-api.commands.executeCommand",
			async () => {
				await API.commands.executeCommand();
			},
		),
		commands.registerCommand(
			"extension.extension-api.commands.getCommands",
			async () => {
	...
	context.subscriptions.push(
		commands.registerCommand(
			"extension.extension-api.debug.activeDebugConsole",
			() => {
				API.debug.activeDebugConsole();
			},
		),
		commands.registerCommand(
			"extension.extension-api.debug.activeDebugSession",
			() => {
				API.debug.activeDebugSession();
			},
		),
		commands.registerCommand(
			"extension.extension-api.debug.breakpoints",
			() => {
	...
	context.subscriptions.push(
		...
		commands.registerCommand(
			"extension.extension-api.env.isNewAppInstall",
			() => {
				API.env.isNewAppInstall();
			},
		),
		commands.registerCommand(
			"extension.extension-api.env.isTelemetryEnabled",
			() => {
	...
	context.subscriptions.push(
		commands.registerCommand(
			"extension.extension-api.extensions.all",
			async () => {
				await API.extensions.all();
			},
		),
		commands.registerCommand(
			"extension.extension-api.extensions.getExtension",
			async () => {
	...
	context.subscriptions.push(
		commands.registerCommand(
			"extension.extension-api.l10n.bundle",
			async () => {
				API.l10n.bundle();
			},
		),
	...
	context.subscriptions.push(
		commands.registerCommand(
			"extension.extension-api.tasks.fetchTasks",
			async () => {
				API.tasks.fetchTasks();
			},
		),
		commands.registerCommand(
			"extension.extension-api.tasks.taskExecutions",
			() => {
	...
	context.subscriptions.push(
		commands.registerCommand(
			"extension.extension-api.window.activeColorTheme",
			() => {
				API.window.activeColorTheme();
			},
		),
		commands.registerCommand(
			"extension.extension-api.window.activeNotebookEditor",
			() => {
				API.window.activeNotebookEditor();
			},
		),
		commands.registerCommand(
			"extension.extension-api.window.activeTerminal",
			() => {
				API.window.activeTerminal();
			},
		),
		commands.registerCommand(
			"extension.extension-api.window.activeTextEditor",
			() => {
		...
		commands.registerCommand(
			"extension.extension-api.window.visibleNotebookEditors",
			() => {
				API.window.visibleNotebookEditors();
			},
		),
		commands.registerCommand(
			"extension.extension-api.window.visibleTextEditors",
			() => {
				API.window.visibleTextEditors();
			},
		),
		commands.registerCommand(
			"extension.extension-api.window.setStatusBarMessage",
			async () => {
				await API.window.setStatusBarMessage();
			},
		),
		commands.registerCommand(
			"extension.extension-api.window.showErrorMessage",
			async () => {
				await API.window.showErrorMessage();
			},
		),
		commands.registerCommand(
			"extension.extension-api.window.showInformationMessage",
			async () => {
				await API.window.showInformationMessage();
			},
		),
		commands.registerCommand(
			"extension.extension-api.window.showInputBox",
			async () => {
				await API.window.showInputBox();
			},
		),
		commands.registerCommand(
			"extension.extension-api.window.showOpenDialog",
			async () => {
				await API.window.showOpenDialog();
			},
		),
		commands.registerCommand(
			"extension.extension-api.window.showQuickPick",
			async () => {
				await API.window.showQuickPick();
			},
		),
		commands.registerCommand(
			"extension.extension-api.window.showSaveDialog",
			async () => {
				await API.window.showSaveDialog();
			},
		),
		commands.registerCommand(
			"extension.extension-api.window.showWarningMessage",
			async () => {
				await API.window.showWarningMessage();
			},
		),
		commands.registerCommand(
			"extension.extension-api.window.showWorkspaceFolderPick",
			async () => {
	...
	context.subscriptions.push(
		...
		commands.registerCommand(
			"extension.extension-api.workspace.isTrusted",
			() => {
		...
		commands.registerCommand(
			"extension.extension-api.workspace.notebookDocuments",
			() => {
				API.workspace.notebookDocuments();
			},
		),
		commands.registerCommand(
			"extension.extension-api.workspace.rootPath",
			() => {
				API.workspace.rootPath();
			},
		),
		commands.registerCommand(
			"extension.extension-api.workspace.textDocuments",
			() => {
				API.workspace.textDocuments();
			},
		),
		commands.registerCommand(
			"extension.extension-api.workspace.workspaceFile",
			() => {
				API.workspace.workspaceFile();
			},
		),
		commands.registerCommand(
			"extension.extension-api.workspace.workspaceFolders",
			() => {
				API.workspace.workspaceFolders();
			},
		),
		commands.registerCommand(
			"extension.extension-api.workspace.asRelativePath",
			() => {
				API.workspace.asRelativePath();
			},
		),
		commands.registerCommand(
			"extension.extension-api.workspace.getConfiguration",
			() => {
				API.workspace.getConfiguration();
			},
		),
		commands.registerCommand(
			"extension.extension-api.workspace.getWorkspaceFolder",
			() => {
				API.workspace.getWorkspaceFolder();
			},
		),
		commands.registerCommand(
			"extension.extension-api.workspace.openNotebookDocument",
			async () => {
				await API.workspace.openNotebookDocument();
			},
		),
		commands.registerCommand(
			"extension.extension-api.workspace.openTextDocument",
			async () => {
				await API.workspace.openTextDocument();
			},
		),
		commands.registerCommand(
			"extension.extension-api.workspace.saveAll",
			async () => {
